"Resource/UI/GlobalExplanations.res"
{
	...
	"FindAMatch"
	{
		...
		"end_wide"		"290"
		"end_tall"		"115"
		"callout_inparents_x"	"200"
		"callout_inparents_y"	"15"
		"next_explanation"		"ReduxCustomization"	
		...
		"TitleLabel"
		{
			...
			"fieldName"		"TitleLabel"
			"font"			"SLItalicMedium"
			"labelText"		"#TF_FindMatchTip_Title"
			"textAlignment"	"north"
			"xpos"			"cs-0.5"
			"ypos"			"10"
			"wide"			"f10"
		...
		"TextLabel"
		{
			...
			"fieldName"		"TextLabel"
			"font"			"HudFontSmall"
			"labelText"		"#TF_FindMatchTip_Body"
			"textAlignment"	"north-west"
			"xpos"			"20"
			"ypos"			"45"
			"wide"			"260"
	...
	"ReduxCustomization"
	{
		...
		"end_wide"		"250"
		"end_tall"		"240"
		"callout_inparents_x"	"345"
		"callout_inparents_y"	"r35"

		"res_file_controls"	"1"
		"explanation_title"	"#TF_CustomizationTip_Title"
		"explanation_body"	"#TF_CustomizationTip_Body"		
		"next_explanation"		"ReduxReportBug"		
	}	
	
	"ReduxReportBug"
	{
		"ControlName"	"CExplanationPopup"
		"fieldName"		"ReduxReportBug"
		"xpos"			"0"
		"ypos"			"0"
		"zpos"			"10000"
		"wide"			"250"
		...
		"explanation_body"	"#TF_ReduxBugTip_Body"				
	}	
